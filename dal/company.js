...
exports.GetByCompany = function(account_id, callback) {
...
exports.GetAllAdds = function(callback) {
...
exports.Delete = function(company, callback) {
    var query = 'DELETE FROM company WHERE company = \'' + comp_id + "';";
    console.log(query);
...
exports.InsertLoc = function(company_info,callback) {
    console.log(company_info);
    var dynamic_query = 'INSERT INTO CompanyLoc VALUES (' +
            '\'' + company_info.cName +
